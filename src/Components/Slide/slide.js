        ...
        >
          {items.map((backgroundColor, index) => (
            ...
            >
                ...
                <img className="imageJacare" title1="Vacina, gostoso demais!" src={backgroundColor.src3} /> {/*Foto apenas do jacaré*/}
