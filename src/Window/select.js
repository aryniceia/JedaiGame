                        ...
                        <div className="level">
                            ...
                            <select onChange={({target}) => 
                                ...
                                id="level" required>
                                    ...
                                    <option value="2">Médio (30 mols e 2 trofeus)</option>
                                    <option value="3">Reprovação (40 mols e 4 trofeus)</option>
                                    <option value="4">Jubilator (50 mols e 2 trofeus difíceis)</option>
                            </select>
